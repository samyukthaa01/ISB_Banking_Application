...
public class BankStatementImpl {
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        Account accountUser = accountRepo.findByAccountNumber(accountNumber);
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("The ISB Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("72, Ampang Hilir, Malaysia"));
        ...
        space.setBorder(0);
        PdfPCell address = new PdfPCell(new Phrase("Account Holder Address " + user.getAddress()));
        address.setBorder(0);
